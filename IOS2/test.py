...
test("Stress test 5 (30, 59, 10, 100)")
processSucess(30, 59, 10, 100)

test("Stress test 6 (300, 599, 0, 0)")
processSucess(300, 599, 0, 0)

test("Stress test 7 (300, 1, 0, 0)")
processSucess(300, 1, 0, 0)

test("Stress test 8 (0, 100, 0, 0)")
processSucess(0, 100, 10, 0)

test("Stress test 9 (100, 0, 0, 0)")
processSucess(100, 0, 10, 0)
